...
public class InvoiceSaver {
    public static void saveInvoiceToFile(String invoiceText, String customer, double total, int cash, int returnAmount) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("VehicleSalesInfo.txt", true))) {
            writer.write("======================================\n"); 
            writer.write(invoiceText);
            writer.write("======================================\n");
          
            JOptionPane.showMessageDialog(null, "Invoice saved to Vehicle Sales Information File!");
